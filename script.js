...
const DETOX_DAYS_CONTENT = {
    ...
    "1": {
        ...
        description: `
            <h3>ЗАВТРАК: Смузи «Очищающий зеленый»</h3>
            <p>Рецепт см. в разделе "Рецепты". Выпить стакан теплой воды, через 30 минут — смузи.</p>
            
            <h3>ПЕРЕКУС: Хлебцы с пюре из авокадо</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ОБЕД: Рис с овощами</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>УЖИН: Салат «Мягкое очищение»</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Активность:** Лёгкая прогулка 45 минут.</p>
        `
    },
    
    // День 2: Активное очищение
    "2": {
        title: "День 2: Активное очищение",
        photoUrl: "menu_day_2.jpg", 
        description: `
            <h3>ЗАВТРАК: Зеленый микс с сельдереем</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ПЕРЕКУС: Горсть нежареных орехов</h3>
            <p>Выберите любые из списка продуктов.</p>
            
            <h3>ОБЕД: Лодочки с рыбой и овощами</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>УЖИН: Овощное спагетти с креветками</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Важно:** Выпить не менее 2,5 литров чистой воды.</p>
        `
    },
    
    // День 3: Полностью растительный день
    "3": {
        title: "День 3: Полностью растительный день",
        photoUrl: "menu_day_3.jpg", 
        description: `
            <h3>ЗАВТРАК: Гречневый пудинг с ягодами</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ПЕРЕКУС: Яблоко и 1 ч.л. семян чиа</h3>
            <p>Семена чиа предварительно замочить.</p>
            
            <h3>ОБЕД: Теплый салат из киноа и авокадо</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>УЖИН: Суп-пюре с сельдереем и шпинатом</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Совет:** Добавьте 1 ч.л. конопляного масла в смузи для поддержки.</p>
        `
    },
    ...
    "4": {
        ...
        description: `
            <h3>ЗАВТРАК: Яблочно-персиковый смузи</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ПЕРЕКУС: Салат «Детокс»</h3>
            <p>Натертая морковь, свекла, чернослив. Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ОБЕД: Теплый салат с лососем и авокадо</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>УЖИН: Киноа с овощами</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Активность:** Йога или растяжка 30 минут.</p>
        `
    },
    ...
    "5": {
        ...
        description: `
            <h3>ЗАВТРАК: Чиа-десерт на кокосовом молоке</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ПЕРЕКУС: Хумус из нута с огурцом</h3>
            <p>Рецепт хумуса см. в разделе "Рецепты".</p>
            
            <h3>ОБЕД: Фаршированная форель</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>УЖИН: Салат с кальмарами</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Перекус:** Вы можете добавить запеченное яблоко, если чувствуете голод.</p>
        `
    },
    
    // День 6: Легкость и закрепление
    "6": {
        title: "День 6: Легкость и закрепление",
        photoUrl: "menu_day_6.jpg", 
        description: `
            <h3>ЗАВТРАК: Очищающий зеленый смузи</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ПЕРЕКУС: Сладкий десерт из авокадо (Конфеты)</h3>
            <p>Одна-две конфеты по рецепту из раздела "Рецепты".</p>
            
            <h3>ОБЕД: Рыба по-азиатски</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>УЖИН: Чечевичный суп-пюре</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Важно:** Добавьте в рацион свекольные конфеты (если нет противопоказаний) для работы кишечника.</p>
        `
    },
    
    // День 7: Завершение и мягкий выход
    "7": { 
        title: "День 7: Завершение и мягкий выход",
        photoUrl: "menu_day_7.jpg", 
        description: `
            <h3>ЗАВТРАК: Пюре из нута и шпината</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <h3>ПЕРЕКУС: Любые разрешенные фрукты</h3>
            <p>Грейпфрут или киви.</p>
            
            <h3>ОБЕД: Салат с киноа и рукколой</h3>
            <p>Рецепт см. в разделе "Рецепты" (использовать рецепт теплого салата из киноа).</p>
            
            <h3>УЖИН: Суп-пюре из брокколи</h3>
            <p>Рецепт см. в разделе "Рецепты".</p>
            
            <p>**Поздравляем!** Начните мягкий переход к обычному питанию, постепенно добавляя более сложные продукты. Удерживайте потребление воды.</p>
        ` 
    },
